    ...
    <body style="background-color:#4682b4">
        <div class="loginbox">
            ...
            <form action="scripts/userManagement.php" method="post">
                ...
                <p>Enter Password:</p>
                <input type="password" maxlength='15' id='p1' name = "password-input1" placeholder="Must be between 8-15 characters">
                <p>Confirm Password:</p>
                <input type="password" maxlength='15' id='p2' name = "password-input2" placeholder="Must be between 8-15 characters">
